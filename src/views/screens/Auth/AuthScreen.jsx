              ...
              <div className="row mt-5">
                <div className="col-5">
                  ...
                  <input type="button" value="Login" className="btn btn-dark" onClick={this.loginHandler}/> */}
                      <ButtonUI className="mr-3" style={{ backgroundColor: "white", color: "black" }} onClick={this.registerHandler}>Register</ButtonUI>
                      <ButtonUI style={{ backgroundColor: "black", color: "white" }} onClick={this.loginHandler}>Login</ButtonUI>
                    </div>
              ...
              <div className="row mt-5">
                <div className="col-5">
                  ...
                  <input type="button" value="Login" className="btn btn-light" style={{backgroundColor: "white"}} onClick={this.loginHandler}/> */}
                      <ButtonUI className="mr-3" style={{ backgroundColor: "black", color: "white" }} onClick={this.registerHandler}>Register</ButtonUI>
                      <ButtonUI style={{ backgroundColor: "white", color: "black" }} onClick={this.loginHandler}>Login</ButtonUI>
                    </div>
